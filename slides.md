...
<div class="absolute top-[3.5rem]">
  <h1 class="!text-7xl !leading-tight font-bold">
    From <span class="bg-gradient-to-r from-[#00d4ff] to-[#00ffcc] bg-clip-text text-transparent">JDK9</span> to <span class="bg-gradient-to-r from-[#a855f7] to-[#d8b4fe] bg-clip-text text-transparent">JDK26</span>
  </h1>
  <div class="mt-4">
...
---
src: ./pages/new-language-features.md
---

---
src: ./pages/new-apis.md
---
